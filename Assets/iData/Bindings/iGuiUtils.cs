...
public class iGuiUtils
{
	public static iGuiDataContext FindRootContext(GameObject gameObject)
	{
		iGuiDataContext context = null; 
		var p = gameObject.transform.parent == null ? null : gameObject.transform.parent.gameObject;
		while (p != null && context == null)
		{
			context = p.GetComponent<iGuiDataContext>();
